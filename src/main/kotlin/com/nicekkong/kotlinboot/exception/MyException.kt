...
class MyException : UserMessageException {
    ...
    constructor(myErrorCode: MyErrorCode): super(myErrorCode.code, myErrorCode.message) {}
    constructor(myErrorCode: MyErrorCode, cause: Throwable?): super(myErrorCode.code, myErrorCode.message, cause) {}
}
